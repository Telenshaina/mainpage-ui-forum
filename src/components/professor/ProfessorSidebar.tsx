import { HelpCircle, Book, Megaphone, Clock, Search, CheckCircle, MessageSquare } from "lucide-react";
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide">
        <div className="space-y-6">
          ...
          {/* Professor-specific tools */}
          <div className="mt-8 pt-6 border-t border-gray-200">
            <h3 className="text-sm font-semibold mb-4 text-gray-900">Professor Tools</h3>
            <div className="space-y-3">
              <Button variant="outline" className="w-full justify-start text-left">
                <CheckCircle size={16} className="mr-2 text-green-600" />
                <span>Content to Verify</span>
              </Button>
              <Button variant="outline" className="w-full justify-start text-left">
